...
export default Component.extend({
    ...
    areFilterOrSearchAvailable: computed('drilldownInfo', function() {
    ...
    isDataSettingsBarVisible: computed('isSearchActive', 'isFilterActive', 'areFilterOrSearchAvailable', function() {
