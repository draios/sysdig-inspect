...
export default Service.extend({
    ...
    headers: computed('session.refererProduct', function() {
        switch (this.get('configTarget')) {
            case 'WEB_SD':
                return {
        ...
        if (this.get('configTarget') === 'WEB_SD') {
            ...
            $.ajaxSetup({
                ...
                beforeSend: (xhr) => {
                    ...
                    let xsrfCookieValuePlatform = this.get('headers.X-XSRF-TOKEN');
                    ...
                    if (xsrfCookieValuePlatform) {
                        xhr.setRequestHeader('X-XSRF-TOKEN', xsrfCookieValuePlatform);
                    }
                },
            });
        }
