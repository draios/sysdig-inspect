...
export default Ember.Service.extend(Ember.Evented, {
    ...
    isSearchActive: Ember.computed.notEmpty('searchDataStore.searchPattern').readOnly(),
    isSearchReady: Ember.computed.and('isSearchActive', 'searchDataStore.hasLoaded').readOnly(),
    ...
    setSearchPattern(searchPattern) {
        ...
        if (this.get('searchDataStore.searchPattern') !== searchPattern) {
            if (Ember.isNone(searchPattern) === false) {
...
const SearchDataStore = PromiseState.extend({
    ...
    viewId: Ember.computed.readOnly('dataStore.viewId'),
    loadingProgress: Ember.computed.readOnly('dataStore.loadingProgress'),
    info: Ember.computed.readOnly('dataStore.info'),
